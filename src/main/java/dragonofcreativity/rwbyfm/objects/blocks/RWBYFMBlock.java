...
public class RWBYFMBlock extends BlockBase {
        public RWBYFMBlock(String name, Material mat, CreativeTabs tab, float hardness, float resistance, String tool, int harvest) {
        ...
        {
                if (this == ItemInit.rwbyfblock1)
                {
                    return null;    
                	//return ItemInit.block_hardlight;
                }
